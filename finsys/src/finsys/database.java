...
//DB CONNECTION
    ...
    database() {
        try {
            ...
            conn = DriverManager.getConnection("jdbc:postgresql://pg-f5e9854.mahfuzt786-393a.aivencloud.com:23795/defaultdb?user=avnadmin&password=rf7r1qr059ur3fw3&sslmode=require");
           } catch (Exception e) {
