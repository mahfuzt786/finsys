...
public class itemwisestock extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Item Wise Stock"));
    ...
    private void btnaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddActionPerformed
        ...
        try {
            r.item_wise(startdate,enddate,m,y);
        } catch (ParseException|JRException|IOException  ex) {
            Logger.getLogger(itemwisestock.class.getName()).log(Level.SEVERE, null, ex);
        } 
