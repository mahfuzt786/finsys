 ...
 * @author pc1
 */
public class dashboard_old extends javax.swing.JFrame implements ActionListener {

    /**
     * Creates new form dashboard_old
     */
    database db;
...
// User Details
    ...
    public dashboard_old() {
        initComponents();
        db = new database();
        setIcon();
    }

    public dashboard_old(String user, Date date) {
...
//               		loadForm("Employee PaySlip", FormEmprptwindow);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dashboard_old.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dashboard_old().setVisible(true);
            }
        });
    }
